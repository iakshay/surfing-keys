...
maps["www.google.com"] = [
  ...
  {
    alias: "p",
    description: "Open search in Perplexity",
    callback: actions.go.perplexity,
  },
]
...
maps["duckduckgo.com"] = [
  ...
  },
  {
    alias: "p",
    description: "Open search in Perplexity",
    callback: actions.dg.perplexity,
  },
  {
    alias: "sgh",
...
maps["perplexity.ai"] = [
  {
    alias: "g",
    description: "Open search in Google",
    callback: actions.perplexity.go,
  },
]
...
const aliases: Record<Domain, Domain[]> = {
  "wikipedia.org": [
    // Wikimedia sites
    "wiktionary.org",
    "wikiquote.org",
